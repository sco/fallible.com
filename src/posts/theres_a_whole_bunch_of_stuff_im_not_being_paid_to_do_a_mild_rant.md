...
comments:
  - author: "Bridget"
    date: "2008-04-24T17:39:25"
    text: |
      Of course there are the teachers (and I can say this, even though I am a teacher) who, if your child is home sick or for whatever reason, you have to beg on a regular basis to get your child's work.  So not right...  Of course then there are the "sackers" at the grocery store, who, after bagging 15 or so filled sacks, asks, "So, do you need me to take this out to your car?"  DUH.
  - author: "Kathryn"
    date: "2008-04-24T19:53:20"
    text: |
      I used to be a technician at a pharmacy. You're right. It is the pharmacy's job to get that refill, and if the doctor doesn't OK the refill, then it's their job to let you know what the doctor told you...preferably before you waste time traveling from point A to point B. It irritated the pharmacists that I sided with the customers on this issue. I hated that job.
      ...
      Great post today.
  - author: "J"
    date: "2008-04-25T20:16:24"
    text: |
      All I can say is "give and it shall be given to you".   That's the verse I quote to myself when I feel overused and overburdened.
      
      Check out <a href="http://myinspiringstory.com">MyInspiringStory</a>
  - author: "PattyT"
    date: "2008-05-22T17:57:16"
    text: |
      Man, Katy, that is the BIGGEST pet peeve of mine at work and in other parts of my life, and is one of the main causes of burnout for employees. I have had to refuse additional responsibilities before even though I know at least the job would get done right because if I had the access to such-and-such computer system &#40;for example&#41;, the others who shared it would stop doing it at all. And because I am low-ranking, I'm really not supposed to be able to say no or to delegate or anything, but I've learned (and am still learning) that my sanity and my long-term health are not only more important, but also should last much longer than this job, even if I did reenlist. So they're not worth risking for this drama.
      
      Also, with companies, like my old Sprint cell contract... I once lost a lot of money to them because I hadn't been able to log onto their website due to my military duties, and they added a service I neither authorized nor used, and the automatic payment just kept going.. so when I found out about it, I tried to explain to them that I shouldn't have had to babysit them, and that they were never authorized to add the charge, and that it doesn't matter HOW long it took for me to notice it on the bill, it was a defiance of our contract and my trust. Then when I got over here and had to disconnect the line, that was another huge headache...
      
      I am SO with you!!!! What happened to work ethics and acceptance of both types of responsibility: the integrity sense and the accomplishments sense?!?
---
